...
public class Scenes1 extends GameWorld {
	public Scenes1(GameStarter game) {
		super(game);
		initScene1();
	}
	...
	void initScene1() {
		...
		// 初始化场景1的背景图和前景图
		bImage = new ImageIcon(getClass().getClassLoader().getResource("images/memory_3.jpg")).getImage();
		fImage = new ImageIcon(getClass().getClassLoader().getResource("images/memory_3_2.png")).getImage();
