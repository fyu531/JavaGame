...
public class GameWorld{
	...
	/*
	 * 初始化游戏场景 所有需要硬编码的都集中在这里。 脏活累活都集中在一个地方，避免污染其它地方。
	 */
	void initGameScene() {
		// 初始化游戏场景背景图和前景图
	...
	void initAllGameObjects() {
		// 创建阿凡达对象，并为阿凡达添加状态
		Avatar avatar = new Avatar(this, new Point2D(400, 400), new Point2D(108, 152), 100, getAmmoParaByName("飞蛇箭"));
		// 添加站立状态
		...
		StopState stop1 = new StopState(vender, 3000, 0, stopAnim1, "",100);
